...
const AlbaniaToolContent = (props: Props) => {
  ...
  const initialSelectedIndustry = flattenedChildData.find(
    ({ value }) => value === industry,
  );

  const [selectedIndustry, setSelectedIndustry] = useState<TreeNode>(
    initialSelectedIndustry as TreeNode,
  );
  ...
  const scatterPlotNode = scatterPlotData.find(
    ({ label }) => label === industryName,
  );
  ...
  const { loading, error, data } = useQuery<SuccessResponse, Variables>(
    GET_DATA_FOR_NACE_ID,
  ...
  if (selectedIndustry === undefined) {
    ...
    content = <FullPageError message={error.message} />;
    nav = null;
    ...
    const factors =
      factorsEdge && factorsEdge.length && factorsEdge[0]
        ? factorsEdge[0].node
        : null;
    const industryNowLocationNode =
      industryNowLocationEdges &&
      industryNowLocationEdges.length &&
      industryNowLocationEdges[0]
        ? industryNowLocationEdges[0].node
        : null;
    const industryNowSchoolingNode =
      industryNowSchoolingEdges &&
      industryNowSchoolingEdges.length &&
      industryNowSchoolingEdges[0]
        ? industryNowSchoolingEdges[0].node
        : null;
    const industryNowOccupationNode =
      industryNowOccupationEdges &&
      industryNowOccupationEdges.length &&
      industryNowOccupationEdges[0]
        ? industryNowOccupationEdges[0].node
        : null;
    ...
    const industryNowWageEdge =
      IndustryNowWageEdges !== null ? IndustryNowWageEdges[0] : null;
    const { schooling, occupation, nearbyIndustry } =
      transformIndustryNowTableData({
    ...
    content = (
      <>
        ...
        <TwoColumnSection>
          ...
          />
          <TextBlock>
            <SubSectionHeader color={colorScheme.quaternary}>
              How Strategic is the Industry?
            </SubSectionHeader>
            <div
              dangerouslySetInnerHTML={{
                __html: getSubsectionText(
        ...
        <TwoColumnSection>
          ...
          <TextBlock>
            ...
            <ParagraphHeader color={colorScheme.quaternary}>
              {SubSectionEnum.RCAInAlbania}
            </ParagraphHeader>
            <SmallParagraph
              dangerouslySetInnerHTML={{
                __html: getSubsectionText(SubSectionEnum.RCAInAlbania),
              }}
            />
            <ParagraphHeader color={colorScheme.quaternary}>
              {SubSectionEnum.LowDistanceToIndustry}
            </ParagraphHeader>
            <SmallParagraph
              dangerouslySetInnerHTML={{
                __html: getSubsectionText(SubSectionEnum.LowDistanceToIndustry),
              }}
            />
            <ParagraphHeader color={colorScheme.quaternary}>
              {SubSectionEnum.HighFDIToPeerCountries}
            </ParagraphHeader>
            <SmallParagraph
              dangerouslySetInnerHTML={{
                __html: getSubsectionText(
            ...
            />
            <ParagraphHeader color={colorScheme.quaternary}>
              {SubSectionEnum.LowContractIntensity}
            </ParagraphHeader>
            <SmallParagraph
              dangerouslySetInnerHTML={{
                __html: getSubsectionText(SubSectionEnum.LowContractIntensity),
              }}
            />
            <ParagraphHeader color={colorScheme.quaternary}>
              {SubSectionEnum.HighElectricityIntensity}
            </ParagraphHeader>
            <SmallParagraph
              dangerouslySetInnerHTML={{
                __html: getSubsectionText(
        ...
        <TwoColumnSection>
          ...
          <TextBlock>
            ...
            <ParagraphHeader color={colorScheme.quaternary}>
              {SubSectionEnum.HighRelativeWages}
            </ParagraphHeader>
            <SmallParagraph
              dangerouslySetInnerHTML={{
                __html: getSubsectionText(SubSectionEnum.HighRelativeWages),
              }}
            />
            <ParagraphHeader color={colorScheme.quaternary}>
              {SubSectionEnum.HighYouthEmployment}
            </ParagraphHeader>
            <SmallParagraph
              dangerouslySetInnerHTML={{
                __html: getSubsectionText(SubSectionEnum.HighYouthEmployment),
              }}
            />
            <ParagraphHeader color={colorScheme.quaternary}>
              {SubSectionEnum.HighGlobalFDIFlows}
            </ParagraphHeader>
            <SmallParagraph
              dangerouslySetInnerHTML={{
                __html: getSubsectionText(SubSectionEnum.HighGlobalFDIFlows),
              }}
            />
            <ParagraphHeader color={colorScheme.quaternary}>
              {SubSectionEnum.HighExportPropensity}
            </ParagraphHeader>
            <SmallParagraph
              dangerouslySetInnerHTML={{
                __html: getSubsectionText(SubSectionEnum.HighExportPropensity),
              }}
            />
          </TextBlock>
        </TwoColumnSection>
        ...
        <TwoColumnSection>
          <SectionHeaderSecondary color={colorScheme.quaternary}>
            {SubSectionEnum.LocationOfWorkers}
          </SectionHeaderSecondary>
          <IndustryNowLocation
        ...
        <TwoColumnSection>
          <SectionHeaderSecondary color={colorScheme.quaternary}>
            {SubSectionEnum.EducationDistribution}
          </SectionHeaderSecondary>
          <DynamicTable
          ...
          <TextBlock>
            <p
              dangerouslySetInnerHTML={{
                __html: getSubsectionText(SubSectionEnum.EducationDistribution),
              }}
            />
          </TextBlock>
        </TwoColumnSection>
        <TwoColumnSection>
          <SectionHeaderSecondary color={colorScheme.quaternary}>
            {SubSectionEnum.OccupationDistribution}
          </SectionHeaderSecondary>
          <DynamicTable
        ...
        <TwoColumnSection>
          <SectionHeaderSecondary color={colorScheme.quaternary}>
            {SubSectionEnum.IndustryWages}
          </SectionHeaderSecondary>
          <IndustryWagesBarChart industryWageEdge={industryNowWageEdge} />
          <TextBlock>
            <p
              dangerouslySetInnerHTML={{
                __html: getSubsectionText(SubSectionEnum.IndustryWages),
              }}
            />
            <Legend
              legendList={[
