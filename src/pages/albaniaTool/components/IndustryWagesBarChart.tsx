...
import { IndustryNowWageEdge } from "../graphql/graphQLTypes";
...
const IndustryWagesBarChart = (props: Props) => {
  ...
  return (
    <DataViz
      ...
      data={tableData}
      axisLabels={{
        left: "Percentage of Workers",
        bottom: "Industry Wages (Lek/Month)",
      }}
    />
  );
};

export default IndustryWagesBarChart;
