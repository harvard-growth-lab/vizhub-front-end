...
const ViabilityRadarChart = (props: Props) => {
  ...
  if (factors) {
    ...
    if (factors.vDist !== null) {
      viabilityData.push({
        label: "Low {{SPACE_OR_LINE}}Distance\nto Industry",
        value: factors.vDist,
      });
    ...
    if (factors.vContracts !== null) {
      viabilityData.push({
        label: "Low Contract\nIntensity",
        value: factors.vContracts,
      });
      viabilityCsvData["Low Contract Intensity"] = factors.vContracts;
    }
    if (factors.vElect !== null) {
      viabilityData.push({
        label: "High {{SPACE_OR_LINE}}Electricity\nIntensity",
        value: factors.vElect,
      });
    ...
    if (targetNaceIndustry) {
      if (targetNaceIndustry.code) {
        viabilityCsvData["3-Digit Industry NACE Code"] =
