    ...
    <>
      ...
      <HubContentContainer>
        <Root>
          <ZigZagContentCard>
            <ZigZagContent>
              The Viz Hub is a portfolio of award-winning, interactive
              visualizations powered by Harvard’s Growth Lab research and
              insights.
            </ZigZagContent>
          </ZigZagContentCard>
          <Title>About</Title>
          <Content>
            ...
            diversity and complexity at the center of the development story.
          </Content>
          <Content>
            ...
            datasets, and pedagogy developed across multidisciplinary teams and
            countless iterations. Since its launch in 2013, the Atlas has been
            complimented by sub-national Atlases, country dashboards,
            interactive stories, open source software packages, and working
            prototypes.
          </Content>
          <Content>
            ...
            <a
              href="https://metroverse.hks.harvard.edu/"
              target="_blank"
              rel="noreferrer"
            >
              Metroverse
            ...
            Beautiful award in the business analytics category.
          </Content>
          <Content>
          ...
          <Content>
            ...
            from research to design, development, and launch. Prior to her work
            at the Growth Lab, Annie was a Director of Digital Product at
            Sustainalytics, an ESG research and consulting firm. She is
            interested in the application of software tools to positively impact
            economic development, equity, and the public interest.
          </Content>

          <Content>
            <a target="_blank" href="https://bleonard.dev/" rel="noreferrer">
              Brendan Leonard
            </a>{" "}
            Senior Back-End &amp; Data Developer
            <br />
            Brendan leads the implementation of back-end technologies and data
            analysis for Viz Hub projects, including management of the
            cloud-based server and database infrastructure. With a particular
            interest in the relationship between technology and democratic
            systems, he holds a master's degree in government studies and a
          ...
          <Content>
            ...
            infrastructure across the Growth Lab's portfolio of digital tools.
            She also contributes to the acquisition and analysis of various
            datasets used across these tools. Ellie has a master's degree in
            computational analysis and public policy from the University of
            Chicago's Harris School.
          </Content>

          <Content>
            <a target="_blank" href="http://www.niltuzcu.net/" rel="noreferrer">
              Nil Tuzcu
            </a>{" "}
            Senior UX/UI &amp; Data Visualization Designer
            <br />
            Nil leads the design vision of Viz Hub projects, encompassing data
            visualization design, prototype development, and user research.
            Previously, Nil worked as a research fellow at MIT's Department of
            Urban Studies and as a research associate at Harvard Graduate School
            of Design. She holds a master's degree from Cornell University and
            was a SPURS Fellow at MIT (2014-2015).
          </Content>
          ...
          <Content>
            <a
              target="_blank"
              href="https://www.tammy-zhang.com/"
              rel="noreferrer"
            >
              Tammy Zhang
            </a>{" "}
